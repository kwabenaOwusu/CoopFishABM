...
res_uncert = 0.4  
# extent to which perception regarding the number of fishes of the group of fishermen as a whole can deviate from the true number of 
# fishes (0,0.4,0.8,1.2) N.B: Maximum uncertainty allowed is 1.2
...
def initialize():
    ...
    We explore the impact of different uncertainties regarding the resource size (number of fishes) 
    and the flow of information among fishermen on harvesting behaviour in a common pool resource system.
...
def update_one_unit_time():
    ...
    csvfile = "/Users/kow/Desktop/TotalandCurrentHarvest.csv"   # a csv-file which produces the time-series of fishes and current harvest
