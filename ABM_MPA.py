...
n = 100 # total time-period for asimulation 
...
# Type of simulation #
MPA = 'yes'   # run simulation with only an MPA? : no or yes (where a 'yes' implies only with MPA and 'no' implies run only without MPA)
Both = 'no'  # run simulation partly without MPA and partly with MPA? : no or yes
Time_MPA = 50 # If Both = 'yes', which time to terminate the MPA? 
...
Frac_MPA = 0.25  # What fraction of the total fishing area should be covered by MPA ? 
