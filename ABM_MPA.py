...
num_fishers = 30#20 # number of pirogues
...
noncoop = 5 # number of noncooperative pirogues
cond_coop = 6 # number of conditional_cooperative pirogues
coop = 7 # number of cooperative pirogues
fully_coop = 8 # number of fully_cooperative pirogues
